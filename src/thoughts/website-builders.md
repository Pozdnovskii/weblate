...
I categorize these tools into three levels of complexity. The boundaries are often blurry and depend on project requirements, platform updates, and third-party integrations.
...
- **Performance** — high loading speed
- **SEO and semantics** — full control over settings, proper HTML tags instead of only divs
- **Accessibility** — ability to add any attributes to improve a11y
- **Flexibility** — connection to any headless CMS
- **Freedom** — free plan and self-hosting option (both for the site and the builder)

<!-- TODO: Add screenshot showing metrics improvement after moving from Webflow to Webstudio -->
